...
interface LabelArtistSelectCardProps {
	artist: ArtistDetail;
	handleSelect: (artist: ArtistDetail) => void;
	selectedIds: string[];
}

const LabelArtistSelectCard: React.FC<LabelArtistSelectCardProps> = (props: LabelArtistSelectCardProps) => {
...
export default LabelArtistSelectCard;
