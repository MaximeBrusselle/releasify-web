...
export function GeneralInfo({ name, realName, description, genreList, contactEmail, updateFields, errors, userType }: GeneralInfoProps) {
				...
				<div className="flex flex-col gap-2 w-full">
					<div className="flex flex-row justify-start items-center m-0 p-0">
						<Label htmlFor="bookingEmail" className="font-bold text-lg">
							{userType === "artist" ? "Bookings Email" : "Contact Email"}
						</Label>
