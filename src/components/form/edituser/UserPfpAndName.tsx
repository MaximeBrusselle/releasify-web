...
type UserPfpAndNameData = {
	name: string;
	profilePicture: File | string;
};

type UserPfpAndNameProps = UserPfpAndNameData & {
	updateFields: (newData: Partial<UserPfpAndNameData>) => void;
	errors: ValidationFieldErrorMap;
};

export function UserPfpAndName({ profilePicture, name, updateFields, errors }: UserPfpAndNameProps) {
