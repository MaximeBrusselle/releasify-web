...
import { EditUserDetails } from "./pages/dashboard/forms/EditUserDetails";
import { EditArtist } from "./pages/dashboard/forms/EditArtist";
import { EditRelease } from "./pages/dashboard/forms/EditRelease";
// Import other pages
