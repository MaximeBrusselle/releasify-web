...
const socialPlatforms: Social[] = [
    ...
    {
        name: SocialPlatform.Apple_music,
        logo: "apple_music_logo.png",
    },
    {
        name: SocialPlatform.Beatport,
        logo: "beatport_logo.png",
    },
    {
        name: SocialPlatform.Tidal,
        logo: "tidal_logo.png",
    },
    {
        name: SocialPlatform.Tiktok,
        logo: "tiktok_logo.jpg",
    },
];

const socialsSynthsation: SocialInfo[] = [
    {
        entityId: "1",
        platform: socialPlatforms[1],
        username: "synthsationdj",
        url: "https://www.instagram.com/synthsationdj"
    },
    {
        entityId: "1",
        platform: socialPlatforms[3],
        username: "Synthsation",
        url: "https://soundcloud.com/user-610792489"
    },
    {
        entityId: "1",
        platform: socialPlatforms[4],
        username: "SynthsationNL",
        url: "https://www.youtube.com/@SynthsationNL/featured"
    }
];
...
const socialsInvaderz: SocialInfo[] = [
    ...
    },
    {
        entityId: "5",
        platform: socialPlatforms[4],
        username: "Invaderzofficial",
        url: "https://www.youtube.com/@invaderzofficial/videos"
    },
    {
        entityId: "5",
        platform: socialPlatforms[5],
...
const socialsArtists: SocialInfo[] = [
    ...socialsSparkz, ...socialsSynthsation, ...socialsKenai, ...socialsScarra, ...socialsInvaderz, ...socialsBmberjck, ...socialsCryex, ...socialsVasto, ...socialsTheSmiler, ...socialsChapterV, ...socialsFaceless
];

export { socialPlatforms, socialsArtists };